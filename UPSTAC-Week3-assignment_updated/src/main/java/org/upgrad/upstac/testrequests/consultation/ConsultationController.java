...
public class ConsultationController {
    ...
    public List<TestRequest> getForConsultations()  {
        ...
        List<TestRequest> li = new ArrayList<>();
        li.addAll(testRequestQueryService.findBy(RequestStatus.COMPLETED));
        return li;
    ...
    public List<TestRequest> getForDoctor()  {
        ...
        List<TestRequest> ress = new ArrayList<>();
        ress.addAlL(testRequestQueryService.findByDoctor(obj));
    ...
    public TestRequest assignForConsultation(@PathVariable Long id) {
        ...
        User obj = new User();
        obj = userLoggedInService.getLoggedInUser();
        TestRequest objt = new TestRequest();

        //testRequestUpdateService.assignForConsultation(objt.getRequestId(),);
        ...
        // return the above created objec
    ...
    public TestRequest updateConsultation(@PathVariable Long id,@RequestBody CreateConsultationRequest testResult) {
        ...
        User obj = new User();
        obj = userLoggedInService.getLoggedInUser();
        TestResult obj1 =new TestResult();
        testRequestUpdateService.updateConsultation(id,Consultation,obj1);
